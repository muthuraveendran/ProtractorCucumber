...
class TakeNotes {
    ...
    answerTo(subject) {
        ...
        return !this.notepad.has(key)
            ? Promise.reject(new errors_1.LogicError(`The answer to "${key}" has never been recorded`))
 ...
 * @package
 */
class TakeNotesUsingAnEmptyNotepad extends TakeNotes {
    /**
     * @desc
     *  Instantiates the {@link Ability} to {@link TakeNotes}
     *
...
TakeNotesUsingASharedNotepad.sharedNotepad = new Map();
