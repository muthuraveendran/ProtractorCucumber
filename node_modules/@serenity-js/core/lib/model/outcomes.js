...
Outcome.fromJSON = (o) => tiny_types_1.match(o.code)
...
ExecutionCompromised.fromJSON = (o) => new ExecutionCompromised(io_1.ErrorSerialiser.deserialise(o.error));
/**
...
ExecutionFailedWithError.fromJSON = (o) => new ExecutionFailedWithError(io_1.ErrorSerialiser.deserialise(o.error));
/**
...
ExecutionFailedWithAssertionError.fromJSON = (o) => new ExecutionFailedWithAssertionError(io_1.ErrorSerialiser.deserialise(o.error));
/**
...
ImplementationPending.fromJSON = (o) => new ImplementationPending(io_1.ErrorSerialiser.deserialise(o.error));
/**
...
ExecutionIgnored.fromJSON = (o) => new ExecutionIgnored(io_1.ErrorSerialiser.deserialise(o.error));
/**
