...
class Scroll extends core_1.Interaction {
     ...
     */
    performAs(actor) {
        return withAnswerOf_1.withAnswerOf(actor, this.target, (elf) => abilities_1.BrowseTheWeb.as(actor).actions().mouseMove(elf).perform());
    }
    /**
     * @desc
     ...
     */
    toString() {
        return io_1.formatted `#actor scrolls to ${this.target}`;
    }
}
