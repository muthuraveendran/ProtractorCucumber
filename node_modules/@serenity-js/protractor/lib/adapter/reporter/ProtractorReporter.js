...
class ProtractorReporter {
    ...
    afterEach() {
        ...
        this.stage.announce(new events_1.AsyncOperationAttempted(new model_1.Description(`[${this.constructor.name}] Invoking ProtractorRunner.afterEach...`), id, this.stage.currentTime()));
        return Promise.resolve(this.runner.afterEach())
            .then(() => this.stage.announce(new events_1.AsyncOperationCompleted(new model_1.Description(`[${this.constructor.name}] ProtractorRunner.afterEach succeeded`), id, this.stage.currentTime())), error => this.stage.announce(new events_1.AsyncOperationFailed(error, id, this.stage.currentTime())));
    }
}
