...
class BrowserDetector {
    ...
    notifyOf(event) {
        if (event instanceof events_1.SceneStarts) {
            ...
            this.stage.announce(new events_1.AsyncOperationAttempted(new model_1.Description(`[${this.constructor.name}] Detecting web browser details...`), id, this.stage.currentTime()));
            Promise.all([
                ...
                this.stage.announce(new events_1.AsyncOperationCompleted(new model_1.Description(`[${this.constructor.name}] Detected web browser details`), id, this.stage.currentTime()));
            });
        }
    }
}
